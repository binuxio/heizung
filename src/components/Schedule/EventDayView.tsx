...
import { AnyEvent, EventDetails } from '../types'
import theme from '../../theme'
import getEventDetails from './utils/getEventDetails'

const EventDayView: React.FC<{ event: AnyEvent }> = ({ event }) => {
    const { startMoment, endMoment, isWeekly, weekDayDate } = getEventDetails(event)
    const weekDayDateMoment = moment(event.weekDayDate)
